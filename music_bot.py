...
async def help_command(ctx):
    ...
    commands_list = {
        "Playback": "!play <song>  Play from YouTube
...
if not TOKEN:
    ...
    print("Add your bot token in Render Environment Variables with key 'TOKEN'")
    # Don't crash - keep the web server running so you can see the error
    import time
    while True:
        time.sleep(60)
else:
